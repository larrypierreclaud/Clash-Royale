...
public class Cochon extends Jouable {
    ...
    Cochon(int x1,int y1){
        super(1600,1600,x1, y1,198,5*UNIT_SIZE,false,true, false, 1600, true);
        ...
        if(this.pv >0) {
            if(which_player==true){
                if(this.pas == 0){ // attack image of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/cochonattack1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else if(this.pas == 1){ // walking image 1 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/cochon1.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/cochon1.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }else{
                if(this.pas == 0){ // attack image of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/cochonattack2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else if(this.pas == 1){ // walking image 1 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/cochon2.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/cochon2.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }
    ...
    public String toString() {
        return "je suis un cochon, mes coordonées : " + this.x +", " +this.y;
    }

    public void draw_card(Graphics g) {
        icoFond2 = new ImageIcon(getClass().getResource("/images/cochon_card.png"));
