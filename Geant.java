...
public class Geant extends Jouable {
    ...
    Geant(int x1,int y1){
        super(4000,4000,x1, y1,160,5*UNIT_SIZE,false,true, false, 1500, true);
    ...
    public void brain() {
        ...
        if(r<=this.portée) {
            //le géant est capable de tirer, donc il ne bouge plus
            this.sens = 0;
            this.pas = 0;
            this.tir(cible);
    ...
    public void move() {
        if(sens==1) {
            this.x = this.x + UNIT_SIZE/2;
            //this.sens =2;
        }else if(sens==2){
            this.x = this.x - UNIT_SIZE/2;
            //this.sens =3;
        }else if(sens==3) {
            this.y = this.y + UNIT_SIZE/2;
            //this.sens=4;
        }else if(sens==4) {
            this.y = this.y -UNIT_SIZE/2;
            //this.sens = 1;
        ...
        if(this.pv >0) {
            if(which_player==true){
                if(this.pas == 0){ // attack image of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/geantattack1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else if(this.pas == 1){ // walking image 1 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/geant1.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/geant1.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }else{
                if(this.pas == 0){ // attack image of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/geantattack2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else if(this.pas == 1){ // walking image 1 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/geant2.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/geant2.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }
    ...
    public String toString() {
        return "je suis un géant, mes coordonées : " + this.x +", " +this.y;
    }

    public void draw_card(Graphics g) {
        icoFond2 = new ImageIcon(getClass().getResource("/images/geant_card.png"));
