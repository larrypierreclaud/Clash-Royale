...
public class Dragon extends Jouable {
    ...
    Dragon(int x1,int y1){
        super(1150,1150,x1, y1,150,10*UNIT_SIZE,true,true, true, 1500, true);
        this.setPreferredSize(new Dimension(80,40)); //nombre total de carrés
        //this.setBackground(Color.white);
        icoFond = new ImageIcon(getClass().getResource("/images/dragon.png"));
        ...
        if(this.pv >0) {
            if(which_player==true){
                if(this.pas == 1){ // walking image 1 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/dragon1.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 1
                    icoFond = new ImageIcon(getClass().getResource("/images/dragon1.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }else{
                if(this.pas == 1){ // walking image 1 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/dragon2.1.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }else{ //walking image 2 of player 2
                    icoFond = new ImageIcon(getClass().getResource("/images/dragon2.2.png"));
                    this.imgFond = this.icoFond.getImage();
                    g.drawImage(this.imgFond, x, y, 132, 157, null);
                }
            }
    ...
    public String toString() {
        return "je suis un dragon, mes coordonées : " + this.x +", " +this.y;
    }

    public void draw_card(Graphics g) {
        icoFond2 = new ImageIcon(getClass().getResource("/images/dragon_card.png"));
